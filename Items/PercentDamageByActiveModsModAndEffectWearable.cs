...
{
    public class PercentDamageByActiveModsModAndEffectWearable : BaseWearableSO
    {
        // dmg mod vars
        ...
        [Min(1f)]
        public int _percentageToModify = 5;
        ...
        public override void TriggerPassive(object sender, object args)
        {
            ...
            Debug.Log("Active Mod Damage Modifier | final percemtage: " + finalPercentage + "%");
            if (_useSimpleInt)
            {
