...
{
    public class DamageIntModCasterStatusAndSecondaryEffect_Item : BaseItem
    {
        public IntDamageModCasterStatusAndEffectWearable item;
        ...
        public DamageIntModCasterStatusAndSecondaryEffect_Item(string itemID = "DefaultID_Item", int integer = 1, bool useDealt = false, bool useInt = false, bool roundNegatives = false, string statusID = "")
        {
            item = ScriptableObject.CreateInstance<IntDamageModCasterStatusAndEffectWearable>();
            item._integerToModify = integer;
            item._useDealt = useDealt;
            item._useSimpleInt = useInt;
            item._roundNegatives = roundNegatives;
            item._statusID = statusID;
