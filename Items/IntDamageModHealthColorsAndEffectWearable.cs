...
{
    public class IntDamageModHealthColorsAndEffectWearable : BaseWearableSO
    {
        // dmg mod vars
        ...
        public override void TriggerPassive(object sender, object args)
        {
            ...
            if (args is DamageDealtValueChangeException context)
            {
                ...
                {
                    if (context.damagedUnit.HealthColor.ContainsPigment([loadedPigment.pigmentID]) && loadedPigment.canGenerateMana)
                    {
