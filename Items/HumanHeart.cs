...
namespace A_Apocrypha.Items
{
    public class HumanHeart
    {
        public static void Add()
        {
            ...
            ItemUtils.AddItemToTreasureStatsCategoryAndGamePool(humanHeart.item, new ItemModdedUnlockInfo("HumanHeart_TW", ResourceLoader.LoadSprite("UnlockComedySimulacrumKillSelfLocked", null, 32, null)));
        }
    }
}
