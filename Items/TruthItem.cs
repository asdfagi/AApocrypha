...
namespace A_Apocrypha.Items
{
    public class TruthItem
    {
        public static void Add()
        {
            ...
            UnlockableModData unlockData = new UnlockableModData("AApocrypha_AnnaMolly_Dreamer_Unlock")
            {
            ...
            ModdedAchievements unlockAchievement = new ModdedAchievements("<color=#" + ColorUtility.ToHtmlStringRGB(Color.magenta) + ">TRUTH</color>", "Unlocked a new item.", ResourceLoader.LoadSprite("AchievementBlueSkyAnnaMolly", null, 32, null), "AApocrypha_AnnaMolly_Dreamer_ACH");
