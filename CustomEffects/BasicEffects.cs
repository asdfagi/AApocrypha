...
namespace A_Apocrypha.CustomEffects
{
    public static class BasicEffects
    {
        ...
        public static SaltPlaySoundEffect PlaySound(string sound)
        {
            SaltPlaySoundEffect ret = ScriptableObject.CreateInstance<SaltPlaySoundEffect>();
            ret.Audio = sound;
            return ret;
        }
    ...
    public class SaltPlaySoundEffect : EffectSO
    {
        public string Audio;
