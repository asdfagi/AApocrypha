    ...
    public class Smouldering : StatusEffect_SO
    {
        ...
        public override void OnEventCall_01(StatusEffect_Holder holder, object sender, object args)
        {
            if (sender is IUnit u)
            {
                ...
                u.Damage(holder.m_ContentMain, null, DeathType_GameIDs.Obliteration.ToString(), 0, false, false, true, (isLogos ? CombatType_GameIDs.Dmg_Linked.ToString() : CombatType_GameIDs.Dmg_Fire.ToString()));
            }
        }
