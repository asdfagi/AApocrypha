...
{
    public class SpecificAlliesByHealthColorTargeting : BaseCombatTargettingSO
    {
        ...
        public override TargetSlotInfo[] GetTargets(SlotsCombat slots, int casterSlotID, bool isCasterCharacter)
        {
            ...
            if (!isCasterCharacter) 
            {
                foreach (var en in enemies.Values)
                {
                    ...
                    if (en.SlotID == casterSlotID && _excludeCaster) { continue; }
            ...
            else 
            {
                foreach (var ch in chars.Values)
                {
                    ...
                    if (ch.SlotID == casterSlotID && _excludeCaster) { continue; }
